...
let compare_case (e1 : Command.logic_expression) (e2 : Command.logic_expression)
...
(** Returns: true if and only if e1 and e2 have the same truth value for the
    ...
    config*)
let rec compare_rec (e1 : Command.logic_expression)
...
let compare (e1 : Command.logic_expression) (e2 : Command.logic_expression) =
